...
import { vacancy, employer, country, speciality, role, user, filter, filtertable } from './components/icons.js';
...
const App = () => (
  ...
  <Admin dataProvider={dataProvider} dashboard={Dashboard}>
    ...
    <Resource name="housing" list={HousingList} edit={HousingEdit} create={HousingCreate} recordRepresentation="name" icon={country}/>
